...
# dimuon = Onia2MUMU, single muon selection is performed above
onia2MuMuPAT = cms.EDProducer('Onia2MuMuPAT',
   ...
   dimuonSelection  = cms.string("0.2 < mass && mass < 12. && abs(daughter('muon1').innerTrack.dz - daughter('muon2').innerTrack.dz) < 25"),
